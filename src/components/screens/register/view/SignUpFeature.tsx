...
const SignUpFeature: React.FC = () => {
  ...
  const { handleSignUp, verifyOTP, loading, otpLoading } =
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="w-full max-w-lg p-8 borderrounded-lg shadow-md rounded-lg"
          style={{
        ...
        >
          ...
          <img
            src={
              theme === "light"
                ? "/image/yourvibes_black.png"
                : "/image/yourvibes _white.png"
            }
            alt="YourVibes"
                  ...
                  validator(_, value) {
                    ...
                    if (selectedDate > today) {
                      return Promise.reject(
                        new Error(
                          localStrings.Form.RequiredMessages.BirthDayInvalidMessage
                        )
                      );
                    }
            ...
            <Form.Item
              ...
              rules={[
                ...
                },
                {
                  pattern: /^\d{10}$/,
                  message:
                    localStrings.Form.RequiredMessages.PhoneInvalidMessage,
                },
              ]}
            >
              <Input
                placeholder={localStrings.Public.Phone}
                className="w-full"
              />
            </Form.Item>
              ...
              <Form.Item
                ...
                rules={[
                  ...
                  },
                  {
                    ...
                    message:
                      localStrings.Form.RequiredMessages.InvalidEmailMessage,
                  },
                ]}
              >
            ...
            <Form.Item
              ...
              rules={[
                ...
                },
                {
                  min: 8,
                  message:
                    localStrings.Form.RequiredMessages.PasswordMinLengthMessage,
                },
              ]}
            >
              <Input.Password
