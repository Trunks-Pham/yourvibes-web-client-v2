...
import { CreateMessageRequestModel, MessageWebSocketResponseModel } from "@/api/features/messages/models/MessageModel";
...
export const WebSocketProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const connectSocketMessage = () => {
        ...
        ws.onmessage = (e) => {
            console.log("📩 Tin nhắn WebSocket nhận được:", e.data);
    ...
    const sendSocketMessage = (message: CreateMessageRequestModel): boolean => {
        ...
        try {
          ...
          console.error("Gửi message qua WebSocket thất bại:", err);
          return false;
        }
    };
